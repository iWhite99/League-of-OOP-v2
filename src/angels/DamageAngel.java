...
public final class DamageAngel extends Angel {
  public DamageAngel(final Position position, final Magician magician) {
  ...
  public void visitDamageAmplifier(final Knight knight) {
    if (knight.getCurrentHp() > 0) {
      knight.setDamageAmplifier(knight.getDamageAmplifier() + Constants.DAMAGE_ANGEL_KNIGHT);
  ...
  public void visitDamageAmplifier(final Pyromancer pyromancer) {
    if (pyromancer.getCurrentHp() > 0) {
      pyromancer.setDamageAmplifier(pyromancer.getDamageAmplifier()
              + Constants.DAMAGE_ANGEL_PYROMANCER);
  ...
  public void visitDamageAmplifier(final Rogue rogue) {
    if (rogue.getCurrentHp() > 0) {
      rogue.setDamageAmplifier(rogue.getDamageAmplifier() + Constants.DAMAGE_ANGEL_ROGUE);
  ...
  public void visitDamageAmplifier(final Wizard wizard) {
    if (wizard.getCurrentHp() > 0) {
      wizard.setDamageAmplifier(wizard.getDamageAmplifier() + Constants.DAMAGE_ANGEL_WIZARD);
